...
#define RESTAURANT_COLLECTION_VIEW_INSETS_GRID              (UIEdgeInsetsMake(16, 10, 20, 10))
#define RESTAURANT_COLLECTION_VIEW_INSETS_LIST              (UIEdgeInsetsMake(0, 0, 0, 0))
#define RESTAURANT_COLLECTION_VIEW_INSETS_DETAILED_LIST     (UIEdgeInsetsMake(20, 10, 20, 10))
...
#define RESTAURANT_COLLECTION_VIEW_CELL_SIZE_DETAILED_LIST  (CGSizeMake(300, 280))
